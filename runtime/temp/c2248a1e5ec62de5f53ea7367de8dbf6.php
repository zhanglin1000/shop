<?php /*a:3:{s:63:"D:\phpEnv\www\shop\application\admin\view\member_level\add.html";i:1559228106;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1559225507;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('memberLevel/add'); ?>" method="post">

                        <div class="form-group">
                            <label for="level_name" class="col-sm-2 control-label no-padding-right">会员级别名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="level_name" placeholder="会员级别名称" name="level_name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="bom_point" placeholder="会员级别下线" name="bom_point" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="top_point" placeholder="会员级别下线" name="top_point" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="reate" placeholder="折扣率" value="100" name="reate" type="text">
                            </div>
