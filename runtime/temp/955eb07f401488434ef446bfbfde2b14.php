<?php /*a:3:{s:60:"D:\phpEnv\www\shop\application\admin\view\recommend\add.html";i:1562141928;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1562641771;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('recommend/add'); ?>" method="post">

                        <div class="form-group">
                            <label for="rec_name" class="col-sm-2 control-label no-padding-right">推荐位名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="rec_name" placeholder="推荐位名称" name="rec_name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin:8px 8px 0 0;">
                                    <input name="rec_type" checked type="radio" value="1" class="colored-blue">
