<?php /*a:3:{s:55:"D:\phpEnv\www\shop\application\admin\view\attr\lst.html";i:1559057148;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1559225507;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
...
<body>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                <a href="<?php echo url('attr/add'); ?>" class="btn btn-azure btn-sm"><i class="fa fa-plus"></i> Add</a>
                <div class="row">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th class="text-center">属性默认值</th>
                                                <th class="text-center">操作</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($attrAll) || $attrAll instanceof \think\Collection || $attrAll instanceof \think\Paginator): $i = 0; $__LIST__ = $attrAll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                                              <tr>
                                                <td align="center"><?php echo htmlentities($attr['id']); ?></td>
                                                <td align="center"><?php echo htmlentities($attr['attr_name']); ?></td>
                                                <td align="center"><?php echo htmlentities($attr['type_name']); ?></td>
                                                <td align="center">
                                                    <?php if($attr['attr_type'] == 1): ?>
                                                     唯一
                                                    <?php else: ?>
                                                     单选
                                                    <?php endif; ?>
                                                ...
                                                <td align="center">
                                                    <?php if($attr['attr_values']): ?>
                                                    <?php echo htmlentities($attr['attr_values']); else: ?>
                                                    暂无商品属性默认值
                                                    <?php endif; ?>
                                                </td>
                                                <td align="center">
                                                    <a href="<?php echo url('attr/edit',array('id'=>$attr['id'],'type_id'=>$attr['type_id'])); ?>" class="btn btn-azure btn-sm">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="<?php echo url('attr/del',array('id'=>$attr['id'])); ?>" onClick="return confirm('你确认要删除这条记录吗？') ? true : false;"  class="btn btn-darkorange btn-sm">
