<?php /*a:3:{s:56:"D:\phpEnv\www\shop\application\admin\view\attr\edit.html";i:1559057249;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1559225507;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                      ...
                      <li>
                        <a href="<?php echo url('attr/lst',array('id'=>input('type_id'))); ?>">属性管理</a>
                      </li>
          ...
          <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">编辑商品属性</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('attr/edit'); ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo htmlentities($attrFind['id']); ?>">
                        <div class="form-group">
                            <label for="attr_name" class="col-sm-2 control-label no-padding-right">商品属性名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="attr_name" placeholder="商品属性名称" name="attr_name" value="<?php echo htmlentities($attrFind['attr_name']); ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">所属商品类型</label>
                            <div class="col-sm-6">
                                <select class="form-control" name="type_id">
                                    ...
                                    <option <?php if($attrFind['type_id'] == $type['id']): ?> selected <?php endif; ?> value="<?php echo htmlentities($type['id']); ?>"><?php echo htmlentities($type['type_name']); ?></option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">属性类型</label>
                            <div class="col-sm-6">
                                <label style="margin:8px 8px 0 0;">
                                    <input name="attr_type" <?php if($attrFind['attr_type'] == 1): ?> checked <?php endif; ?> type="radio" value="1" class="colored-blue">
                                    <span class="text">唯一</span>
                                </label>
                                <label style="margin:8px 8px 0 0;">
                                    <input name="attr_type" <?php if($attrFind['attr_type'] == 2): ?> checked <?php endif; ?> type="radio" value="2" class="colored-blue">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">属性可选值</label>
                            <div class="col-sm-6">
                               <textarea class="form-control" rows="5" name="attr_values"><?php echo htmlentities($attrFind['attr_values']); ?></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">(注：属性可选值用逗号分割)</p>
                        </div>
