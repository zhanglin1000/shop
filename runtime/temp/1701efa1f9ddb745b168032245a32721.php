<?php /*a:3:{s:59:"D:\phpEnv\www\shop\application\admin\view\article\edit.html";i:1557930688;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1559225507;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
          ...
          <div class="widget">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('article/edit'); ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo htmlentities($articleFild['id']); ?>" />
                        <input type="hidden" name="thumb" value="<?php echo htmlentities($articleFild['thumb']); ?>" />
                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content tabs-flat">
                                        <div id="home1" class="tab-pane active">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="文章标题" name="title" value="<?php echo htmlentities($articleFild['title']); ?>" required="" type="text">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="cate_id" style="width: 100%;">
                                                        ...
                                                        <option onclick="article_status(this)" article_url="<?php echo url('article/article_status'); ?>" <?php if($articleFild['cate_id'] == $cate['id']): ?> selected <?php endif; ?> value="<?php echo htmlentities($cate['id']); ?>"><?php if($cate['pid'] != 0): ?><?php echo '♩'.str_repeat('-',$cate['level'] * 8); ?><?php endif; ?><?php echo htmlentities($cate['cate_name']); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <label style="margin:8px 8px 0 0;">
                                                        <input name="important" <?php if($articleFild['important'] == 1): ?> checked <?php endif; ?> type="radio" value="1" class="colored-blue">
                                                        <span class="text">普通</span>
                                                    </label>
                                                    <label style="margin:8px 8px 0 0;">
                                                        <input name="important" type="radio" <?php if($articleFild['important'] == 2): ?> checked <?php endif; ?> value="2" class="colored-blue">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <label style="margin:8px 8px 0 0;">
                                                        <input name="status" <?php if($articleFild['status'] == 1): ?> checked <?php endif; ?> type="radio" value="1" class="colored-blue">
                                                        <span class="text">显示</span>
                                                    </label>
                                                    <label style="margin:8px 8px 0 0;">
                                                        <input name="status" type="radio" <?php if($articleFild['status'] == 0): ?> checked <?php endif; ?> value="0" class="colored-blue">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="author" placeholder="文章作者" value="<?php echo htmlentities($articleFild['author']); ?>" name="author" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="email" placeholder="文章email" value="<?php echo htmlentities($articleFild['email']); ?>" name="email" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="keyword" placeholder="关键字" value="<?php echo htmlentities($articleFild['keyword']); ?>" name="keyword" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" id="desc" placeholder="网页描述" name="desc"><?php echo htmlentities($articleFild['desc']); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="link_url" placeholder="外部链接" value="<?php echo htmlentities($articleFild['link_url']); ?>" name="link_url" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <?php if($articleFild['thumb']): ?>
                                                    <img src="http://shop.com/public/static/uploads/article/<?php echo htmlentities($articleFild['thumb']); ?>" width="50" height="50"/>
                                                    <?php else: ?>
                                                    暂无缩略图
                                                    <?php endif; ?>
                                                </div>
                                        ...
                                        <div id="home2" class="tab-pane">
                                            <textarea name="content" id="content"><?php echo htmlentities($articleFild['content']); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
