<?php /*a:1:{s:59:"D:\phpEnv\www\shop\application\member\view\account\reg.html";i:1565174657;}*/ ?>
﻿<!doctype html>
<html>
<head>
    ...
    <script type="text/javascript" src="http://shop.com/public/static/plugin/layer/layer.js"></script>
    <script type="text/javascript" src="http://shop.com/public/static/index/js/jquery.cookie.js"></script>
    <script type="text/javascript" src="http://shop.com/public/static/index/js/register.js"></script>
    <script type="text/javascript">
        var url = "<?php echo url('account/sendEmail'); ?>";
    </script>
</head>
                    ...
                    <div class="form form-other">
                        <form action="<?php echo url('account/reg'); ?>" method="post" name="formUser">
                            <div class="item">
                                ...
                                <div class="item-info">
                                    <input type="text" name="username" id="username" required class="text" value=""
                                           autocomplete="off"/>
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-info">
                                    <input type="password" name="password" id="password" required class="text" value=""
                                           autocomplete="off"/>
                                </div>
                                <div class="input-tip"></div>
                            </div>
                            <div class="item">
                                ...
                                <div class="item-info">
                                    <input type="password" name="confirm_password" required id="pwdRepeat" class="text"
                            ...
                            <div class="item" id="email_yz" style="display:block;">
                                <div class="item-label">邮 箱 验 证</div>
                                <div class="item-info">
                                    <input type="text" name="email" id="email" class="text ignore" value=""
                                           autocomplete="off"/>
                            ...
                            <div class="item" id="code_email" style="display:block;">
                                <div class="item-label">邮箱验证码</div>
                                <div class="item-info">
                                    <input type="text" name="send_code" id="send_code" class="text text-2 ignore"
                                           value="" autocomplete="off"/>
                                    <input type="button" class="sms-btn" id="zemail" value="获取验证码">
                                </div>
                                <div class="input-tip"></div>
                            </div>
                            ...
                            <div class="item item2">
                                <div class="item-checkbox">
                                    ...
                                    <label class="ui-solid-label" for="clause2">我已阅读并同意<a href="article.php?id=6"
                                                                                          class="ftx-05"
                                                                                          target="_blank">《用户注册协议》</a></label>
                                </div>
                                <div class="input-tip"></div>
                            </div>
                            <div class="item item2 item-button">
                                <input type="submit" id="registsubmit" name="Submit" maxlength="8"
