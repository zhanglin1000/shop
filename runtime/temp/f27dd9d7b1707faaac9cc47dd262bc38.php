<?php /*a:3:{s:54:"D:\phpEnv\www\shop\application\admin\view\ad\edit.html";i:1563799971;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1563270465;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1563691095;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('ad/edit'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="adpos_id" style="width: 100%;">
                                    ...
                                    <option <?php if($adposFind['adpos_id'] == $adpos['id']): ?> selected <?php endif; ?>  value="<?php echo htmlentities($adpos['id']); ?>"><?php echo htmlentities($adpos['name']); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="ad_name" placeholder="广告名称" name="ad_name" value="<?php echo htmlentities($adposFind['ad_name']); ?>" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin-top:8px;margin-right:8px;">
                                    <input name="statue" <?php if($adposFind['statue'] == 1): ?>checked<?php endif; ?> value="1" type="radio" class="colored-blue">
                                    <span class="text">开启 </span>
                                </label>
                                <label style="margin-top:8px;">
                                    <input name="statue" <?php if($adposFind['statue'] == 0): ?>checked<?php endif; ?> value="0" type="radio" class="colored-blue">
                        ...
                        <div class="col-sm-6">
                            <label style="margin-top:8px;margin-right:8px;">
                                <input name="ad_type" id="img" <?php if($adposFind['ad_type'] == 1): ?> checked <?php else: ?> disabled <?php endif; ?> value="1" type="radio" class="colored-blue">
                                <span class="text">图片广告 </span>
                            </label>
                            <label style="margin-top:8px;">
                                <input name="ad_type" <?php if($adposFind['ad_type'] == 2): ?> checked <?php else: ?> disabled <?php endif; ?> id="lh" value="2" type="radio" class="colored-blue">
                        ...
                        <div class="form-group img" <?php if($adposFind['ad_type'] == 1): ?> style="display:block;"<?php else: ?> style="display:none;"  <?php endif; ?>>
                            <div style="display:inline-block;width:100%;">
                                    ...
                                    <div class="col-sm-6">
                                         ...
                                         <img src="<?php echo APP_PATH; ?>/public/static/uploads/picture/<?php echo htmlentities($adposFind['img_src']); ?>" height="50px;" />
                                         <?php else: ?>
                                         暂无缩略图
                                         <?php endif; ?>
                                    </div>
                            ...
                            <div  style="display:inline-block;width:100%;" >
                               ...
                               <div class="col-sm-6">
                                   <input class="form-control" style="margin-top:8px;" value="<?php echo htmlentities($adposFind['link']); ?>" type="text" name="link">
                               </div>
                            </div>
                        </div>
