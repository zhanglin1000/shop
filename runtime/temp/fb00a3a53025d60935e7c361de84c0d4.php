<?php /*a:3:{s:55:"D:\phpEnv\www\shop\application\admin\view\attr\add.html";i:1559055015;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1559225507;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                      ...
                      <li>
                        <a href="<?php echo url('attr/lst'); ?>">属性管理</a>
                      </li>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('attr/add'); ?>" method="post">

                        <div class="form-group">
                            <label for="attr_name" class="col-sm-2 control-label no-padding-right">商品属性名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="attr_name" placeholder="商品属性名称" name="attr_name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin:8px 8px 0 0;">
                                    <input name="attr_type" checked type="radio" value="1" class="colored-blue">
