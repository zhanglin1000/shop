<?php /*a:3:{s:55:"D:\phpEnv\www\shop\application\admin\view\type\add.html";i:1558967699;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1558966346;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('type/add'); ?>" method="post">

                        <div class="form-group">
                            <label for="type_name" class="col-sm-2 control-label no-padding-right">商品类型名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="type_name" placeholder="商品类型名称" name="type_name" required="" type="text">
                            </div>
