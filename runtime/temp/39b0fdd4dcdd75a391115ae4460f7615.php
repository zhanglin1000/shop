<?php /*a:3:{s:55:"D:\phpEnv\www\shop\application\admin\view\link\add.html";i:1558107197;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1558966346;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('link/add'); ?>" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="link_name" class="col-sm-2 control-label no-padding-right">链接名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="link_name" placeholder="链接名称" name="link_name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="link_url" placeholder="链接地址" name="link_url" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin:8px 8px 0 0;">
                                    <input name="link_status" checked type="radio" value="1" class="colored-blue">
                                    <span class="text">显示</span>
                                </label>
                                <label style="margin:8px 8px 0 0;">
                                    <input name="link_status" type="radio" value="0" class="colored-blue">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin:8px 8px 0 0;">
                                    <input name="link_type" checked type="radio" value="1" class="colored-blue">
                                    <span class="text">文字</span>
                                </label>
                                <label style="margin:8px 8px 0 0;">
                                    <input name="link_type" type="radio" value="2" class="colored-blue">
