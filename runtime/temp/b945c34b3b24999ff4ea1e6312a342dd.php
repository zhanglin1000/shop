<?php /*a:3:{s:61:"D:\phpEnv\www\shop\application\admin\view\recommend\edit.html";i:1562142889;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1562141172;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                      ...
                      <li>
                        <a href="<?php echo url('recommend/lst'); ?>">推荐位管理</a>
                      </li>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('recommend/edit'); ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo htmlentities($recFind['id']); ?>" />
                        <div class="form-group">
                            <label for="rec_name" class="col-sm-2 control-label no-padding-right">推荐位名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="rec_name" placeholder="推荐位名称" value="<?php echo htmlentities($recFind['rec_name']); ?>" name="rec_name" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label  class="col-sm-2 control-label no-padding-right">推荐位类型</label>
                            <div class="col-sm-6">
                                <label style="margin:8px 8px 0 0;">
                                    <input name="rec_type" <?php if($recFind['rec_type'] == 1): ?> checked <?php endif; ?> type="radio" value="1" class="colored-blue">
                                    <span class="text">商品</span>
                                </label>
                                <label style="margin:8px 8px 0 0;">
                                    <input name="rec_type" <?php if($recFind['rec_type'] == 2): ?> checked <?php endif; ?> type="radio" value="2" class="colored-blue">
