<?php /*a:3:{s:56:"D:\phpEnv\www\shop\application\admin\view\type\edit.html";i:1558968677;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1563269130;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1563072950;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
    ...
    <!-- /Sidebar Menu -->
          ...
          <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">编辑商品类型</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('type/edit'); ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo htmlentities($typeFind['id']); ?>">
                        <div class="form-group">
                            <label for="type_name" class="col-sm-2 control-label no-padding-right">商品类型名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="type_name" placeholder="商品类型名称" name="type_name" value="<?php echo htmlentities($typeFind['type_name']); ?>" required="" type="text">
                            </div>
