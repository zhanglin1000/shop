<?php /*a:3:{s:54:"D:\phpEnv\www\shop\application\admin\view\nav\lst.html";i:1562133364;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1562641771;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
...
<body>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                <a href="<?php echo url('nav/add'); ?>" class="btn btn-azure btn-sm"><i class="fa fa-plus"></i> Add</a>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php if(is_array($navList) || $navList instanceof \think\Collection || $navList instanceof \think\Paginator): $i = 0; $__LIST__ = $navList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                                              <tr>
                                                <td align="center"><?php echo htmlentities($nav['id']); ?></td>
                                                <td align="center"><?php echo htmlentities($nav['nav_name']); ?></td>
                                                <td align="center">
                                                    <?php if($nav['nav_url']): ?>
                                                    <?php echo htmlentities($nav['nav_url']); else: ?>
                                                     暂无网址
                                                    <?php endif; ?>
                                                </td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo url('nav/edit',['id'=>$nav['id']]); ?>" class="btn btn-azure btn-sm">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="<?php echo url('nav/del',['id'=>$nav['id']]); ?>" onClick="return confirm('你确认要删除这条记录吗？') ? true : false;"  class="btn btn-darkorange btn-sm">
