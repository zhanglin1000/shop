<?php /*a:3:{s:63:"D:\phpEnv\www\shop\application\admin\view\member_level\lst.html";i:1559228067;s:57:"D:\phpEnv\www\shop\application\admin\view\public\top.html";i:1557143759;s:58:"D:\phpEnv\www\shop\application\admin\view\public\left.html";i:1559225507;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>雪狐商城</title>
...
<body>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                <a href="<?php echo url('memberLevel/add'); ?>" class="btn btn-azure btn-sm"><i class="fa fa-plus"></i> Add</a>
                <div class="row">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th class="text-center">级别下线</th>
                                                <th class="text-center">级别上线</th>
                                                <th class="text-center">折扣率</th>
                                                <th class="text-center">操作</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($member_levelAll) || $member_levelAll instanceof \think\Collection || $member_levelAll instanceof \think\Paginator): $i = 0; $__LIST__ = $member_levelAll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ml): $mod = ($i % 2 );++$i;?>
                                              <tr>
                                                <td align="center"><?php echo htmlentities($ml['id']); ?></td>
                                                <td align="center"><?php echo htmlentities($ml['level_name']); ?></td>
                                                <td align="center"><?php echo htmlentities($ml['bom_point']); ?></td>
                                                <td align="center"><?php echo htmlentities($ml['top_point']); ?></td>
                                                <td align="center"><?php echo htmlentities($ml['reate']); ?></td>
                                                <td align="center">
                                                    <a href="<?php echo url('memberLevel/edit',array('id'=>$ml['id'])); ?>" class="btn btn-azure btn-sm">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="<?php echo url('memberLevel/del',array('id'=>$ml['id'])); ?>" onClick="return confirm('你确认要删除这条记录吗？') ? true : false;"  class="btn btn-darkorange btn-sm">
